...
export function Hero() {
  return (
    <div className="bg-[linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url('https://images.pexels.com/photos/325876/pexels-photo-325876.jpeg')] bg-center bg-cover h-[60vh]">
